            ...
            <Col>
              {showPoll ? (
                <div style={{ marginLeft: "30px" }}>
                  <div style={{ fontSize: "20px", backgroundColor: userVote === 'optionOne' ? "#fcdf5b" : "white" }}>
                    {optionOne}
                    {userVote === "optionOne" ? (
                    ...
                    <Card style={{ backgroundColor: userVote === 'optionOne' ? "#fcdf5b" : "white" }}>
                    <ProgressBar striped 
                  ...
                  <div style={{ fontSize: "20px", marginTop: "10px",  backgroundColor: userVote === 'optionTwo' ? "#fcdf5b" : "white" }}>
                    {optionTwo}
                    {userVote === "optionTwo" ? (
                      <Badge pill bg="success" style={{ marginLeft: "20px" }}>
                        your choice
                    ...
                    <Card style={{ backgroundColor: userVote === 'optionTwo' ? "#fcdf5b" : "white" }}>
                    <ProgressBar striped 
                      style={{ height: "20px", margin: '5px' }}
                      variant="success"
                      now={votesTwo}
